...
class AddonDependency(object):
    ...
    @property
    def name(self):
        """Gets the name of this AddonDependency.  # noqa: E501


        :return: The name of this AddonDependency.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AddonDependency.


        :param name: The name of this AddonDependency.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddonDependency, dict):
